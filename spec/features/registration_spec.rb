...
feature 'Регистрация' do
  before(:each) do
    ...
    fill_in 'registration_email', with: FFaker::Internet.email
    fill_in 'registration_name', with: FFaker::Name.name
    fill_in 'registration_password', with: '123123aA'
    fill_in 'registration_company', with: FFaker::Company.name
  end
